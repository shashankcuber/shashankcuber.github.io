...
Currently, my work includes developing **continuous and arbitrary-scale image super-resolution methods** using implicit-neural-representation.

Before moving into research, I worked as a Software Engineer at **Red Hat**, **nference** and **Clear**.

## Recent News

- **May, 2026** — 🎉 Our paper **"ppLM-CO: Parameter-Efficient Codon Optimization with Frozen Pre-trained Protein Language Model and Guaranteed Translation Fidelity"** was accepted at **ACM-BCB 2026**.
- **September, 2024** - Started PhD at [Visual Lab](https://ualbertavisual.ca/) at UofA
- **August, 2024** — Successfully defended my Msc thesis !!
- **September, 2022** - Started my Msc (thesis-track) in CS at UofA.

## Research Interests

`Deep Learning` · `Image Super-Resolution` · `Generative Models` · `Computational Biology`